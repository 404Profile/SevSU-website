    ...
    <div>
        ...
        <FormSection @submitted="createApiToken">
            ...
            <template #description>
                Токены API позволяют сторонним сервисам проходить аутентификацию в приложении от вашего имени.
            </template>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                <div>
                    Пожалуйста, скопируйте ваш новый токен API. В целях вашей безопасности он больше не будет отображаться.
                </div>
        ...
        <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            <template #title>
                Разрешения на использование токенов API
            </template>
