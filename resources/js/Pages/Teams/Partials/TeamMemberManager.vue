...
<template>
    <div>
            ...
            <div v-if="team.users.length === 6">
                <ActionSection class="mt-10 sm:mt-0">
                    ...
                    <template #description>
                        Добавьте нового члена команды в свою команду, чтобы он мог сотрудничать с вами.
                    </template>

                    <template #content>
                        <p>В команде уже максимальное число участников (6).</p>
                    ...
                    <template #form>
                        <div class="col-span-6">
                            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                                Пожалуйста, укажите адрес электронной почты человека, которого вы хотели бы добавить в эту команду.
                            </div>
                        </div>
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title>
                    Ожидающие приглашения в команду
                </template>

                <template #description>
                    Эти люди были приглашены в вашу команду, и им было отправлено электронное письмо с приглашением. Они могут присоединиться к вашей команде, приняв приглашение по электронной почте.
                </template>
        ...
        <div v-if="team.users.length > 0">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Все люди, которые являются частью этой команды.
                </template>
        ...
        <ConfirmationModal :show="confirmingLeavingTeam" @close="confirmingLeavingTeam = false">
            ...
            <template #content>
                Вы уверены, что хотели бы покинуть эту команду?
            </template>
        ...
        <ConfirmationModal :show="teamMemberBeingRemoved" @close="teamMemberBeingRemoved = null">
            ...
            <template #content>
                Вы уверены, что хотели бы исключить этого человека из команды?
            </template>
